 ...
 */
final class Version20180803165803 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE companies CHANGE bank_affiliate_id bank_affiliate_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE companies DROP FOREIGN KEY FK_8244AA3A5F8A2381');
        $this->addSql('ALTER TABLE companies CHANGE bank_affiliate_id bank_affiliate_id INT NOT NULL');
